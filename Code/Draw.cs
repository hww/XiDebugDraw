 ...
 *			b.	`XiDebugDraw` namespace and `Draw` class name, you can change this into your project's namespace to make it more accessable.
 ...
 *	3.	Don't rename this file of 'XiDebugDraw' or this won't work. This file contains a MonoBehavior also named 'XiDebugDraw' and Unity needs this file
 *		to have the same name. If you really want to rename this file, remember to rename the 'XiDebugDraw' class below too.
 *	
...
namespace XiDebugDraw
{
	public static class Draw
	{
		...
		#region Internal
		/// <summary>
		/// Singleton XiDebugDraw component that is needed to call Unity APIs.
		/// </summary>
		...
		private static void CheckAndBuildHiddenRTDrawObject()
		{
			...
			_rtDraw =  GameObject.FindObjectOfType<XiDebugDraw.Internal.RuntimeDebugDraw>();
			if (_rtDraw != null)
				return;

			//	instantiate an hidden gameobject w/ XiDebugDraw attached.
			...
			_rtDraw = childGo.AddComponent<XiDebugDraw.Internal.RuntimeDebugDraw>();
			//	hack to only hide outer go, so that XiDebugDraw's OnGizmos will work properly.
	...
	public static class DrawEditor
	{
		static DrawEditor()
		{
			...
			var name = typeof(XiDebugDraw.Internal.RuntimeDebugDraw).Name;
...
namespace XiDebugDraw.Internal
{
	internal class RuntimeDebugDraw : MonoBehaviour
	{
		...
		{
			//	as XiDebugDraw component has a very low execution order, other script might Awake()
